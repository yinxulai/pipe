...
const (
	...
	SettingNameBasicHeader          = "basicHeader" // Removed from UI since v1.1.0 caused by issue 54 (https://github.com/yinxulai/pipe/issues/54)
...
const (
	...
	SettingBasicHeaderDefault           = "<!-- https://github.com/yinxulai/pipe/issues/54 -->"
	SettingBasicBasicNoticeBoardDefault = "<!-- 支持 Markdown -->本博客由 [Pipe](https://github.com/yinxulai/pipe) 强力驱动"
)
